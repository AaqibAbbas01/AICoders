    ...
    <div className="py-16 bg-gray-900">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl font-bold mb-6 text-white">About AI Coders Hub</h1>
          <p className="text-lg text-gray-300 mb-8">
            At AI Coders Hub, our mission is to empower testers and developers with the latest automation tools and techniques. We believe that modern testing requires a combination of technical expertise, critical thinking, and innovative approaches.
          </p>
        </div>
