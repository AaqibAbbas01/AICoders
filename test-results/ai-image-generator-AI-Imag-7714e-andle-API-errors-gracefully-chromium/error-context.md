...
- Name: AI Image Generator >> should handle API errors gracefully
- Location: /Users/aaqibabbas/institute-website/tests/ai-image-generator.spec.ts:31:7
...
Call log:
  - waiting for getByLabel('Prompt')
    ...
    at /Users/aaqibabbas/institute-website/tests/ai-image-generator.spec.ts:41:37
```
